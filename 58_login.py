...
class Post_Login(object):
    def __init__(self, user, password):
        ...
        self.url_login = 'https://passport.58.com/58/login/pc/dologin'
        self.url_token = 'https://passport.58.com/58/login/init?source=58-default-pc&path=https%253A%252F%252Ffz.58.com%252F%253Fpts%253D1576132528933&psdk-d=jsdk&psdk-v=1.0.2&callback=JsonpCallBack1576132529634985'
        self.headers = {
                        'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',
                        'referer': 'https://passport.58.com/login/?path=https://fz.58.com/&PGTID=0d100000-0013-0294-1ceb-b5750bd206e9&ClickID=2',
...
'''
    ...
    def login(self):
        ...
        docjs = execjs.compile(self.js)
        password = docjs.call('encryptString', self.password)
        data = {
            'username': self.username,
            'password': password,
            'token': token,
            'source': '58-default-pc',
            'path': 'https%3A%2F%2Ffz.58.com%2F%3Fpts%3D1576130658645',
            'domain': '58.com',
            'finger2': 'zh-CN|24|2|4|1280_800|1280_777|-480|1|1|1|undefined|1|unknown|MacIntel|unknown|3|false|false|false|false|false|0_false_false|d41d8cd98f00b204e9800998ecf8427e|0ca7cc1aa43799f727836690fb1b42a8',
            'psdk-d': 'jsdk',
            'psdk-v': '1.0.2',
            'fingerprint': 'nISIveDQx7MmlNxJ6xqIWOw4AGs3lC4u',
            'callback': 'SDK_CALLBACK_FUN.successFun',
        }
        response = requests.post(self.url_login, data=data, headers=self.headers)
        # 成功登陆，匹配成功登陆后的信息
        token = re.findall('msg":"(.*?)"', response.text)
        if len(token) == 0:
            print('登陆失败')
        else:
            print(token[0])
